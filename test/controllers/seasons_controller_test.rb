...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { begin_at: @season.begin_at, number: @season.number, program_id: @season.program_id } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { begin_at: @season.begin_at, number: @season.number, program_id: @season.program_id } }
